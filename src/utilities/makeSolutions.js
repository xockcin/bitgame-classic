...
const sortSolutionsByLength = (grid) => {
    const allSolutionsArray = _.flatten(grid)
    let sortedSolutions = new Array(10).fill([])
    allSolutionsArray.map(item => sortedSolutions[item.solution.length - 1].push(item))
    return sortedSolutions
}

console.log(solutionsGrid[34][79])
console.log(solutionsGrid[211][0])
console.log(solutionsGrid[1][32])
console.log(solutionsGrid[34][35])